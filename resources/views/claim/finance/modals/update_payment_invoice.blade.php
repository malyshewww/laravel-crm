<div class="modal fade" id="updatePaymentInvoice-{{$itemInvoice->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content modal__content">
			...
			<form action="{{route('payment_invoice.update')}}" method="post" id="formPaymentInvoice-{{$itemInvoice->id}}" class="form">
				@csrf
				@method('patch')
				<input type="hidden" name="claim_id" value="{{$claim->id}}">
				<input type="hidden" name="invoice_id" value="{{$itemInvoice->id}}">
