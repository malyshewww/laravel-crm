<div class="modal fade modal-extended" id="addTourist" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content modal__content">
			<div class="modal__header">
				<div class="modal__title">Турист</div>
...
<script type="text/javascript">
	// const formTourist = document.getElementById('formTourist');
	// const formData = new FormData(formTourist);
	// formData.append('surname', formData.tourist_surname)
	// formData.append('name', formData.tourist_name)
	// formData.append('email', formData.tourist_email)
