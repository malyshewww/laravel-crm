<div class="modal fade modal-extended" id="updateFuelSurchange-{{$fs->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content modal__content">
			...
			<form action="{{route('fuelsurchange.update')}}" method="post" id="formFuelSurchangeUpdate" class="form">
				...
				<input type="hidden" name="fuelsurchange_id" value="{{$fs->id}}">
