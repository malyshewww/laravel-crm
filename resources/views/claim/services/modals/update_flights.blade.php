<div class="modal fade modal-extended" id="updateFlight" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content modal__content">
			...
			<form action="" method="post" id="formFlightUpdate">
				@csrf
				@method('patch')
				...
				<div class="modal__body">
					{{-- Разметка с данными из шаблона modal_update_flight --}}
				</div>
