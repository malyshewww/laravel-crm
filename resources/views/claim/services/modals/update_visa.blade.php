<div class="modal fade modal-extended" id="updateVisa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	...
	<div class="modal-content modal__content">
		...
		<form action="" method="post" id="formVisaUpdate">
			@csrf
			@method('patch')
			...
			<div class="modal__body">
				{{-- Разметки с данными из шаблона modal_update_visa --}}
			</div>
