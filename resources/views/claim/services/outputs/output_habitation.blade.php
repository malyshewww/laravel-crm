			...
			<td class="table__actions">
				<div class="table__buttons">
					<div class="table__button-item" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Редактировать услугу">
						<button class="btn-gear" type="button" data-id="{{$habitation->id}}" data-bs-toggle="modal" data-bs-target="#updateHabitation-{{$habitation->id}}">
							<i class="fa-solid fa-gear"></i>
						</button>
					</div>
					<div class="table__button-item" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Удалить услугу">
						<button class="btn-trash" type="button" data-type="delete" data-id="{{$habitation->id}}" data-url="{{route('habitation.destroy', $habitation->id)}}" data-bs-toggle="modal" data-bs-target="#deleteRecord">
